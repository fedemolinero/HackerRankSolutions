...
function removeOneDigit(s, t) {
    // soLUTION:   NO WAY TO SOLVE ALL THIS EXERCISES WITHOUT PRACTICE XD
    // SO I WILL WRITE THE SOLUTION 

    // CHECK IF THEY ARE SORT LEXICOGRAPHIC
    // SORT( S < T )

    // CHECK OCCURENCIES OF THE SECOND STRING WITH THE FIRST ONE WITH FOR LOOP
    // RETURN SOLUTION
